...
<head>
    ...
    <title>Miss Fashion Boutique</title>
        ...
        <div id="top-header">
            <div class="container">
                <ul id="head_links" class="header-links pull-left">
                    <li style="font-size:18px">Miss Fashion Boutique</li>

                </ul>
                <ul class="header-links pull-right">
                    @if(session()->has('user'))
                    <li><a style="color:white" href="{{route('user.history')}}">{{session()->get('user')->full_name}} Order's List </a></li>
                    <li style="font-size:15px"><a href="{{route('user.logout')}}"><i class="fa fa-user-o"></i> Logout</a></li>
                    @else
                    <li style="font-size:15px"><a href="{{route('user.login')}}"><i class="fa fa-user-o"></i> Login</a></li>

                    <li style="font-size:15px"><a href="{{route('user.signup')}}"><i class="fa fa-user-o"></i> Register</a></li>
                    @endif
                ...
                <div class="row">
                    <div class="col-md-3 col-xs-6">
                        <div class="footer">
                            ...
                            <p>We offer Bridal Package, Wedding Gowns, Coats and Barong, Pants, Long sleeves, Formal Dress etc.</p>
                            <ul class="footer-links">
                                <li><a href="#"><i class="fa fa-map-marker"></i>Zone 1, San Isidro Pob. Nabua, Camarines Sur 2nd flr. of LBC & Bakers Plaza</a></li>
                                <li><a href="#"><i class="fa fa-phone"></i>0987654321</a></li>
                                <li><a href="#"><i class="fa fa-envelope-o"></i>missfashion@email.com</a></li>
                            </ul>
                        </div>
                    </div>
