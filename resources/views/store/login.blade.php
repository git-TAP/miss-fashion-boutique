        ...
        <div class="row" style="text-align:center">
            ...
            <form method="post" id="loginForm">
                ...
                <div class="col-md-4">
                    ...
                    <img src="{{asset('images/logo.jpg')}}" alt="logo" style="width: 200px;height 200px;">
                        <div class="section-title">
                        
                            <h3 class="title">User Login</h3>
                        </div>
                        <div class="form-group">
                            <input class="input" type="email" name="email" id="email" placeholder="Email" value="user@mail.com">
                        </div>
                        <div class="form-group">
