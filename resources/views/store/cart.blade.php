...
<!--                            -->
                    ...
                    <div class="order-col">
                        ...
                        <div ><strong class="order-total" id="totalCost">{{Session::get('price')}} &#8369</strong></div>
                    </div>
                    @else
                    <div class="order-col">
...
<script>
   ...
   //TO DO: ajax will take place
    ...
    $.ajax({
            ...
            {
                document.getElementById("individualPrice_"+order_serial).innerHTML=x*product_price+" &#8369";
                document.getElementById("totalCost").innerHTML = msg[2]+" &#8369";
            }
            });
