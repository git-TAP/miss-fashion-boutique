...
body {
  ...
  background: -webkit-linear-gradient(right, #946D75, #AE2A94);
  background: -moz-linear-gradient(right, #946D75, #AE2A94);
  background: -o-linear-gradient(right, #946D75, #AE2A94);
  background: linear-gradient(to left, #946D75, #AE2A94);
  font-family: "Roboto", sans-serif;
